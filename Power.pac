// ============================================================
// PUBG JORDAN + GULF ULTIMATE v13.0 - SPLIT PROXY
// ============================================================
// ✅ بروكسي منفصل: لوبي / مباريات
// ✅ أردن أولوية - خليج fallback
// ✅ Backup proxy للوبي
// ✅ Private IP → DIRECT
// ✅ بلوك كامل للدول الممنوعة
// ============================================================

// ========== PROXY SERVERS ==========

// بروكسيات اللوبي الأساسية
...
// بروكسيات اللوبي الاحتياطية (Backup)
var LOBBY_BACKUP_1 = "PROXY 188.247.66.133:443";
var LOBBY_BACKUP_2 = "PROXY 188.123.160.201:443";
var LOBBY_BACKUP_3 = "PROXY 212.35.85.26:443";

// سلسلة البروكسيات للوبي (أساسي + احتياطي)
var LOBBY_CHAIN = LOBBY_PROXY_1 + "; " + LOBBY_PROXY_2 + "; " + 
                  LOBBY_BACKUP_1 + "; " + LOBBY_BACKUP_2 + "; " + LOBBY_BACKUP_3;
...
function FindProxyForURL(url, host) {
  ...
  // ============================================================
  // اللوبي: بروكسيات منفصلة مع backup
  // ============================================================
  if (isLobby(host)) {
    ...
    if (isJordanWindow()) {
      ...
      if (jo) return LOBBY_CHAIN;
      return BLOCK;
    }

    // بعد 45 ثانية - أردن + خليج
    if (jo) return LOBBY_CHAIN;
    if (gu) return LOBBY_CHAIN;
    return BLOCK;
  }

  // ============================================================
  // مباراة: بروكسي مخصص للمباريات فقط
  // ============================================================
...
// ============================================================
// END - PUBG JORDAN + GULF ULTIMATE v13.0
// ============================================================
