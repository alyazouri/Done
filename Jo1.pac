// ============================================================
// PUBG JORDAN + GULF ULTIMATE v12.0
// ============================================================
...
// ✅ بلوك كامل لكل الدول الثانية
// ✅ Session لوبي ذكي
// ✅ DNS مزدوج للثبات
// ============================================================

// ========== PROXY ==========
var PROXY  = "PROXY 82.212.84.161:1080";
var DIRECT = "DIRECT";
...
function FindProxyForURL(url, host) {
  ...
  // ============================================================
  // اللوبي: 45 ثانية أردن فقط → بعدها أردن + خليج
  // ============================================================
  if (isLobby(host)) {
  ...
  // ============================================================
  // مباراة + كل ترافيك PUBG: أردن + خليج بدون قيود
  // ============================================================
  if (jo) return PROXY;
  if (gu) return PROXY;
...
// ============================================================
// END - PUBG JORDAN + GULF ULTIMATE v12.0
// ============================================================
